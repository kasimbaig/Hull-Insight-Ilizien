  ...
  const handleMouseDown = (e) => {
    ...
    if (currentTool === "hand") {
      ...
      const defaultProps = {
        ...
        fill: "#FFFFFF",
        stroke: "#000000",
        metadata: { label: "New Annotation", severity: "Low", color: "#FFFFFF" },
      };
      ...
      e.stopPropagation();
    } else if (["rect", "circle", "path"].includes(target.tagName)) {
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="w-64 p-4 border-r bg-gray-50 space-y-4 rounded-md">
        ...
        <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={() => setCurrentTool("hand")}> <Hand className="mr-2 h-4 w-4" /> Hand Tool </Button>
        <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={deleteShape}> <Trash2 className="mr-2 h-4 w-4" /> Delete </Button>
        <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={handleZoomIn}> <ZoomIn className="mr-2 h-4 w-4" /> Zoom In </Button>
        <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={handleZoomOut}> <ZoomOut className="mr-2 h-4 w-4" /> Zoom Out </Button>
        ...
        <div className="mt-4 space-y-2">
          <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={exportAsSVG}> Export SVG </Button>
          <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={() => exportAsImage('png')}> Export PNG </Button>
          <Button variant="outline" className="w-full rounded-lg shadow-sm" onClick={() => exportAsImage('pdf')}> Export PDF </Button>
        </div>
      </div>
      {/* Canvas */}
